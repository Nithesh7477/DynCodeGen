...
{
    public partial class BuildConnectionAdo : Form
    {
        private readonly AdoCreateControl _adoCreateControlParent;
        private readonly AdoEnhanceControl _adoEnhanceControlParent;
        public BuildConnectionAdo(AdoCreateControl adoCreateControlParent, AdoEnhanceControl adoEnhanceControlParent)
        {
            InitializeComponent();
